...
const Cart = () => {
  ...
  const increseQty = (item, quantity) => {
    ...
    if (newQty > item?.stock) return; // Ensure stock is available
  ...
  const setItemToCart = (item, newQty) => {
    ...
    dispatch(setCartItem(cartItem)); // Update cart with new quantity
  };

  const removeCartItemHandler = (id) => {
    dispatch(removeCartItem(id)); // Remove item from cart
  };
